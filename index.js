...
var parallaxInstance = new Parallax(scene);  // Parallax Code 
...
var slider = new Swiper(".swiper-container", {   // Lenna besh jebena el Keys o hatinhoum f div
  // Optional parameters
  slidesPerView: "auto",
  spaceBetween: 150,
  centeredSlides: true,
  ...
  pagination: {
    ...
    renderBullet: function(index, className) {
      return '<div class="' + className + '">' + keys[index] + "</div>";   // lenna kifeh mesh yjiw fel html
    }
  }
});
